...
#
default_application = 'empathica'    # ordinarily set in base routes.py
...
#
#routes_onerror = [
#    (r'empathica/404', r'/empathica/static/notfound.html')
#   ,(r'empathica/400', r'/empathica/static/fail.html')
